...
DEFAULTUSER = str(ALIVE_NAME) if ALIVE_NAME else "**No name set yet nibba,JAI SHAKTIMAN
USER_BOT_WARN_ZERO = "`You were spamming my peru master's inbox, henceforth your retarded lame ass has been blocked by my master's userbot.` **Now GTFO, i'm playing PUBG AND minecraft** "
